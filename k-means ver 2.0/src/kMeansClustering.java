...
public class kMeansClustering {
     ...
     * 将数据聚成 k 类。
     */
    public static void cluster(HashMap<Integer,HashMap<Integer,Double>> p, int k) {
    	HashMap<Integer,HashMap<Integer,Double>> oldcenterVector = new HashMap<>();// 存放聚类旧的聚类中心
    	HashMap<Integer,HashMap<Integer,Double>> newcenterVector = new HashMap<>();// 存放新计算的聚类中心
